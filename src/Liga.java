...
/**
 * Klasa Liga ima odredjeni broj timova (x timova)
 * U ligu se mogu dodavati timovi i mogucnost simuliranja lige je npr. metoda zapocni ligu.
 * Prvi clan lige je prvi tim igra utaksmicu sa jos nekim clanom lige i 
 *  pobjeda se racuna na osnovu sposobnosti igraca
 * @author Amra
 *
 */
public class Liga {
